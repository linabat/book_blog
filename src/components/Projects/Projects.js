...
import { Container, Row, Col } from 'react-bootstrap';
import ProjectCard from './ProjectCards'; // Make sure the import matches the filename
...
function Projects() {
  ...
  const genres = ['Romance', 'Historical Fiction', 'Fantasy', 'Science Fiction'];
  const subtropes = ['Fake Relationship', 'Enemies to Lovers', 'Small Town Romance', 'Marriage of Convenience'];
  ...
  const books = [
    {
      ...
      title: "Grayson's Vow",
      author: "Mia Sheridan",
      description: "Marriage of convenience...",
      rating: "⭐⭐⭐⭐",
      dateFinished: "08/20/2022",
      review: "IS THIS WORKING PROPRELY",
      ghLink: "https://youtube.com",
      genre: 'Romance',
      subtrope: 'Marriage of Convenience'
    },
  ...
  const filteredBooks = books.filter(book => {
    return (
      ...
      (selectedSubtrope === '' || book.subtrope === selectedSubtrope)
    );
  });
    ...
    <Container fluid className="project-section">
      <Container>
        <h1 className="project-heading">
          Book Review <strong className="purple">Thought Dump</strong>
        </h1>
        <p style={{ color: "white" }}>
        ...
        <FilterBar
          ...
          onSubtropeChange={setSelectedSubtrope}
        />
